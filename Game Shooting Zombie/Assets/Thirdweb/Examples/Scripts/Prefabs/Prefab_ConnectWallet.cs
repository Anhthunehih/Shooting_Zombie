    ...
    public class Prefab_ConnectWallet : MonoBehaviour
    {
        ...
        public async void Disconnect()
        {
            ...
            try
            {
                ...
                StartScreen.GetComponent<StartScreenScript>().toogleEndScreen(ConnectedState, DisconnectedState);
            }
        ...
        private async void Connect(WalletConnection wc)
        {
            ...
            try
            {
               ...
               exportButton.SetActive(wc.provider == WalletProvider.LocalWallet);
                StartScreen.GetComponent<StartScreenScript>().toogleStartScreen(ConnectedState, DisconnectedState,_address);
            }
            catch (Exception e)
            {
                _address = null;
